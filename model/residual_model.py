...
class ResidualModel:
    ...
    def policy_model(self, data, feature_tensor):
        return base.model_head(data, feature_tensor, [3072, 2048, model.NUM_LABELS])

    def result_model(self, data, feature_tensor):
        return base.model_head(data, feature_tensor, [4096, 2048, 1024, 512, 1], use_tanh_at_end = True)
